...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<div class="col-lg-4 teachers-grid__item <?foreach ($arItem["PROPERTIES"]["groups"]["VALUE"] as $group):?> group<?=$group?><?endforeach;?>  <?foreach ($arItem["PROPERTIES"]["clubs"]["VALUE"] as $group):?> group<?=$group?><?endforeach;?>">
